...
function Root(props: RootInterface) {
  const img_array_male = [[img_spa_1,img_spa_2,img_spa_3,img_spa_4,img_spa_5],[img_haircut_1,img_haircut_2,img_haircut_3,img_haircut_4,img_haircut_5],[img_color_1,img_color_2,img_color_3,img_color_4,img_color_5]]
  const label_array_male = [["Classic Hair Spa",
  ...
  const img_array_female = [[img_w_hair_1,img_w_hair_2,img_w_hair_3,img_w_hair_4,img_w_hair_5],[img_facial_1,img_facial_2,img_facial_3,img_facial_4,img_facial_5],[img_bleach_1,img_bleach_2,img_bleach_3,img_bleach_4,img_bleach_5]]
  const label_array_female = [["Dream Curls","Straight Finish","Shampoo & Blast Dry","Splitend Cuts","Hair Trimming"],["Acne Cleanup","Basic Cleanup","Fairness Facial","Gold Facial","Under-Eye Rejuvenation"],["Neck Bleach","Full-Body Bleach","Feet Bleach","Full-Arm Bleach","Upper-Lip Bleach"]]
  ...
  return (
    ...
    <button className="bg-green-700 hover:bg-green-900 disabled:bg-green-900 text-white font-bold py-2 px-4 border border-green-900 border-transparent h-10 w-32 -ml-[40.5em]" disabled={gender} onClick={() => (setGender((prev) => !prev))}>Men</button>
    <button className="bg-green-700 hover:bg-green-900 disabled:bg-green-900 text-white font-bold py-2 px-4 border border-green-900 h-10 w-32 " disabled={!gender} onClick={() => (setGender((prev) => !prev))}>Women</button>
    </div>
 


    {gender ? title_array_male.map((item: any,index:number) => ( 
